...
const SupportMessageSchema = new mongoose_1.Schema({
    ticketId: { type: mongoose_1.Schema.Types.ObjectId, ref: "SupportTicket", required: true, index: true },
    senderType: { type: String, enum: ["user", "admin"], required: true },
    senderUserId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User" },
    senderAdminId: { type: mongoose_1.Schema.Types.ObjectId, ref: "AdminUser" },
