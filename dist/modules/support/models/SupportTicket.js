...
const SupportTicketSchema = new mongoose_1.Schema({
    ...
    priority: { type: String, enum: Object.values(contracts_1.SupportPriority), default: contracts_1.SupportPriority.MEDIUM, index: true },
    status: { type: String, enum: Object.values(contracts_1.SupportStatus), default: contracts_1.SupportStatus.OPEN, index: true },
